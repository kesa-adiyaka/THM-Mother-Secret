...
const addArrow = _0x1005d3 => {
    const _0x1094b2 = _0x267948;
    let _0x205dbb = contentx;
    const _0x48ef0b = document[_0x1094b2(0xf2)](_0x1094b2(0xf9));
    allBoxes[_0x1094b2(0x10e)]((_0x5b4433, _0x40d7ad) => {
        const _0x1e5f91 = _0x1094b2;
        _0x5b4433['innerHTML'] = boxes[_0x40d7ad], _0x1005d3 == _0x40d7ad && (_0x5b4433[_0x1e5f91(0x10c)](_0x1e5f91(0x10f), arrow), _0x48ef0b[_0x1e5f91(0x101)] = '', _0x48ef0b[_0x1e5f91(0x10c)](_0x1e5f91(0x10f), _0x1e5f91(0xe7) + _0x205dbb[value] + _0x1e5f91(0xeb)));
    });
};
let value = 0x0;
document[_0x267948(0xe6)](_0x267948(0xfc), function(_0x24853f) {
    const _0x31f3e6 = _0x267948;
    var _0x4fa5b9 = _0x24853f[_0x31f3e6(0xed)] || _0x24853f[_0x31f3e6(0x103)];
    switch (_0x4fa5b9) {
        case 0x26:
            value = value - 0x1;
            if (value < 0x0) value = 0x0;
            removeArrow(), addArrow(value);
            break;
        case 0x28:
            value = value + 0x1;
            if (value > 0x3) value = 0x3;
            removeArrow(), addArrow(value);
            break;
        default:
            return;
